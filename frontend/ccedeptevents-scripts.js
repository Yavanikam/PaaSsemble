document.addEventListener('DOMContentLoaded', function() {
    ...
    const events = [
      {
        title: 'Advanced CCE Seminar',
        description: 'Explore cutting-edge topics in CCE engineering.',
        img: 'https://via.placeholder.com/800x400',
        contact: '+1 234 567 891'
      },
      {
        title: 'CCE Hackathon',
        description: 'Join the CCE hackathon and compete with the brightest minds in the field.',
        img: 'https://via.placeholder.com/800x400',
