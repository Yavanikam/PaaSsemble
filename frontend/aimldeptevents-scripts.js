document.addEventListener('DOMContentLoaded', function() {
    ...
    const events = [
      {
        title: 'Advanced AIML Seminar',
        description: 'Explore cutting-edge topics in AIML engineering.',
        img: 'https://via.placeholder.com/800x400',
        contact: '+1 234 567 891'
      },
      {
        title: 'AIML Hackathon',
        description: 'Join the AIML hackathon and compete with the brightest minds in the field.',
        img: 'https://via.placeholder.com/800x400',
