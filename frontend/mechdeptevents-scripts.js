document.addEventListener('DOMContentLoaded', function() {
    ...
    const events = [
      {
        title: 'Advanced Mechanical Seminar',
        description: 'Explore cutting-edge topics in Mechanical engineering.',
        img: 'https://via.placeholder.com/800x400',
        contact: '+1 234 567 891'
      },
      {
        title: 'Mechanical Hackathon',
        description: 'Join the Mechanical hackathon and compete with the brightest minds in the field.',
        img: 'https://via.placeholder.com/800x400',
