document.addEventListener('DOMContentLoaded', function() {
    ...
    const events = [
      {
        title: 'Advanced CSE Seminar',
        description: 'Explore cutting-edge topics in computer science and engineering.',
        img: 'https://via.placeholder.com/800x400',
        contact: '+1 234 567 891'
      },
      {
        title: 'AI Hackathon',
        description: 'Join the AI hackathon and compete with the brightest minds in the field.',
        img: 'https://via.placeholder.com/800x400',
