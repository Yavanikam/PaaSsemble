document.addEventListener('DOMContentLoaded', function() {
    ...
    const events = [
      {
        title: 'Advanced IOT Seminar',
        description: 'Explore cutting-edge topics in IOT engineering.',
        img: 'https://via.placeholder.com/800x400',
        contact: '+1 234 567 891'
      },
      {
        title: 'IOT Hackathon',
        description: 'Join the IOT hackathon and compete with the brightest minds in the field.',
        img: 'https://via.placeholder.com/800x400',
